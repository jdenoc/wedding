...
<?php } elseif(isset($_GET['gift'])) { // GIFTS ?>
    <form action="res/update.php?gift=bvhjaskd&add=sbhjksvbdhk" method="post">
        <table border="0" style="color: #111;" id="add_song">
            <tr>
                <th colspan="2">Add Gift</th>
            </tr><tr>
                <td colspan="2"><div class="sexy_line"></div></td>
            </tr><tr>
                <td><label for="giver">Gift Giver:</td>
                <td><input type="text" name="giver" id="giver" maxlength="100" /></td>
            </tr><tr>
                <td><label for="gift">Gift:</label></td>
                <td><textarea name="gift" id="gift" maxlength="255" ></textarea></td>
            </tr><tr>
                <td>Thanked:</td>
                <td style="text-align: center">
                    <label>Yes <input type="radio" name="thank" value="1" /></label>
                    <label>No <input type="radio" name="thank" value="0" /></label>
                </td>
            </tr><tr>
                <td>&nbsp;</td>
            </tr><tr>
